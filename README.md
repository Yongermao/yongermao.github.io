...
<p class="mt-1">版权所有：Yongermao</p>
</div>
<div class="text-gray-500 text-xs sm:text-sm flex flex-col items-center md:items-end">
<p>意见反馈：</p>
<p class="mt-1 flex items-center justify-center md:justify-end">
